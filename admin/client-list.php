    ...
    <main class="main">
      <section class="section-box">
        <div class="banner-hero banner-1">
          <div class="container">
            <h3>Client list</h3><br>
            <div class="row">
              <table>
                <thead>
                  <tr>
                    <th class="list">Full name</th>
                ...
                <tbody>
                  <?php foreach ($clients as $client) {
                    ...
                    ?>
                  <tr>
                    <td class="text"><br><br><?php echo $fullname ?></td>
                    <td class="text"><br><br><?php echo $client['email']?></td>
                    <td class="text"><br><br><?php echo $client['telephone']?></td>
                    <td><br><br><a class="btn btn-outline-danger" href="client-list.php?ID_user=<?php echo $client[
                        "ID_user"
                    ]; ?>">Delete</a>
