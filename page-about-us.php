...
<head>
  ...
  <title>About us - Ecom Marketplace Template</title>
</head>
      ...
      <div class="main-header">
        <div class="header-left">
          ...
          <div class="header-shop">
            ...
            </div><a class="font-lg icon-list icon-wishlist" href="shop-wishlist.php"><span>Wishlist</span><?php if ($wish_counter > 0) {
                                                                                                              echo '<span class="number-item font-xs">' . $wish_counter . '</span>';
                                                                                                            } ?></span></a>
            <div class="d-inline-block box-dropdown-cart"><span class="font-lg icon-list icon-cart"><span>Cart</span><?php if ($cart_counter > 0) {
                                                                                                                        echo '<span class="number-item font-xs">' . $cart_counter . '</span>';
                                                                                                                      } ?></span>
          ...
          <div class="col-lg-10 mx-auto">
            ...
            <div class="row mt-20">
              <div class="box-contact-support pt-80 pb-50 pl-50 pr-50 background-gray-50 mt-50 mb-90">
                <h3 class="mb-40">Our Team</h3>
                <div class="row mb-50">
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="card-staff hover-up">
                      <div class="image-staff"><img src="profile.png" alt="Ecom"></div>
                      <div class="info-staff">
                        <h5>HIAMSIMO</h5>
                        <p class="font-md color-gray-500">4th year CS Student</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="box-images-logo"><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/microsoft.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/sony.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/acer.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/nokia.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/asus.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/casio.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/dell.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/panasonic.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/vaio.svg" alt="Ecom"></a><a class="hover-up" href="shop-vendor-single.html"><img src="fonts/sharp.svg" alt="Ecom"></a></div>
                ...
                <div class="col-lg-10">
                  <div class="row">
                    ...
                    <div class="col-lg-3 text-center mb-30">
                      <div class="box-image mb-20"><img src="fonts/chat.svg" alt="Ecom"></div>
                      <h4 class="mb-5">Chat to sales</h4>
                      <p class="font-sm color-gray-700 mb-5">Speak to our team.</p><a class="font-sm color-gray-900" href="/cdn-cgi/l/email-protection#d8abb9b4bdab98bdbbb7b5f6bbb7b5">Mehdi.Oumaima@Marketech.com</a>
                    </div>
                    <div class="col-lg-3 text-center mb-30">
                      <div class="box-image mb-20"><img src="fonts/call.svg" alt="Ecom"></div>
                    ...
                    <div class="col-lg-3 text-center mb-30">
                      <div class="box-image mb-20"><img src="fonts/map.svg" alt="Ecom"></div>
                      <h4 class="mb-5">Visit us</h4>
                      <p class="font-sm color-gray-700 mb-5">Visit our office</p><span class="font-sm color-gray-900"><br>Agadir, Morocco</span>
                    </div>
                  </div>
                </div>
              </div>
